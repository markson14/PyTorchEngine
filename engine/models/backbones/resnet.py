    ...
    def load_state_dict(self, state_dict, strict=False, **kwargs):
        ...
        for k in state_dict.keys():
            if k.startswith('conv1'):
                state_dict_new[k.replace('conv1', 'stem.0')] = state_dict[k]
            elif k.startswith('bn1'):
                state_dict_new[k.replace('bn1', 'stem.1')] = state_dict[k]
            state_dict_new[k] = state_dict[k]
        return super().load_state_dict(state_dict_new, strict, **kwargs)
...
def resnet10(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet('resnet12', BasicBlock, [1, 1, 1, 1], pretrained, progress,
                   **kwargs)
